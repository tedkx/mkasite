...
function wrap_visible_url(a,b){return a.length<=b?a:(dashPos=a.indexOf("-"),dashPos>-1&&dashPos<=b?a:(slashPos=a.indexOf("/"),slashPos>-1&&slashPos<=b?a.substr(0,slashPos+1)+"<br>"+a.substr(slashPos+1,60):a.substr(0,b-1)+"<br>"+a.substr(b-1,70)))}!function(){for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b,c){var d=(new Date).getTime(),e=Math.max(0,16-(d-a)),f=window.setTimeout(function(){b(d+e)},e);return a=d+e,f}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)})}(),$(function(){function j(){a=window.innerWidth,b=window.innerHeight,f={x:a/2,y:b/3},c=document.getElementById("spiders"),c.width=a,c.height=b,d=c.getContext("2d"),e=[];for(var g=0;a>g;g+=a/i)for(var j=0;b>j;j+=b/i){var k=g+Math.random()*a/i,l=j+Math.random()*b/i,m={x:k,originX:k,y:l,originY:l};e.push(m)}for(var n=0;n<e.length;n++){for(var o=[],p=e[n],q=0;q<e.length;q++){var r=e[q];if(p!=r){for(var u=!1,v=0;5>v;v++)u||void 0==o[v]&&(o[v]=r,u=!0);for(var v=0;5>v;v++)u||t(p,r)<t(p,o[v])&&(o[v]=r,u=!0)}}p.closest=o}for(var n in e){var w=new s(e[n],2+2*Math.random(),h+"0.3)");e[n].circle=w}}function k(){"ontouchstart"in window||window.addEventListener("mousemove",l),window.addEventListener("scroll",m),window.addEventListener("resize",n)}function l(a){var b=posy=0;a.pageX||a.pageY?(b=a.pageX,posy=a.pageY):(a.clientX||a.clientY)&&(b=a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,posy=a.clientY+document.body.scrollTop+document.documentElement.scrollTop),f.x=b,f.y=posy}function m(){g=document.body.scrollTop>b?!1:!0}function n(){a=window.innerWidth,b=window.innerHeight,c.width=a,c.height=b}function o(){p();for(var a in e)q(e[a])}function p(){if(g){d.clearRect(0,0,a,b);for(var c in e)Math.abs(t(f,e[c]))<4e3?(e[c].active=.3,e[c].circle.active=.6):Math.abs(t(f,e[c]))<2e4?(e[c].active=.1,e[c].circle.active=.3):Math.abs(t(f,e[c]))<4e4?(e[c].active=.02,e[c].circle.active=.1):(e[c].active=0,e[c].circle.active=0),r(e[c]),e[c].circle.draw()}requestAnimationFrame(p)}function q(a){TweenLite.to(a,1+1*Math.random(),{x:a.originX-50+100*Math.random(),y:a.originY-50+100*Math.random(),onComplete:function(){q(a)}})}function r(a){if(a.active)for(var b in a.closest)d.beginPath(),d.moveTo(a.x,a.y),d.lineTo(a.closest[b].x,a.closest[b].y),d.strokeStyle=h+a.active+")",d.stroke()}function s(a,b,c){var e=this;!function(){e.pos=a||null,e.radius=b||null,e.color=c||null}(),this.draw=function(){e.active&&(d.beginPath(),d.arc(e.pos.x,e.pos.y,e.radius,0,2*Math.PI,!1),d.fillStyle=h+e.active+")",d.fill())}}function t(a,b){return Math.pow(a.x-b.x,2)+Math.pow(a.y-b.y,2)}if(document.getElementById("spiders")){var a,b,c,d,e,f,g=!0,h="rgba(160,160,160,",i=15;j(),o(),k()}});

window.mka={baseUrl:(window.location.href+"").split("#")[0],currentPaneId:"#home-pane",firstLoad:!0,mapCenter:{lat:37.943497,lng:23.6521346},paneTransitionDur:.6,projectCache:{},projectIds:["#projects","#private","#constructions","#subprojects"],projectTransitionDur:.5,projectsInitialized:!1,map:null,mapStyles:[{featureType:"road",stylers:[{visibility:"simplified"},{saturation:-27},{gamma:1.8}]},{featureType:"landscape.natural",stylers:[{hue:"#ffbb00"},{saturation:54}]},{featureType:"road.local",stylers:[{hue:"#ff5e00"},{saturation:-24},{visibility:"simplified"},{lightness:28}]},{featureType:"road.highway",elementType:"geometry",stylers:[{hue:"#ff8800"},{saturation:-79},{lightness:-16},{visibility:"simplified"}]},{featureType:"road.arterial",elementType:"labels",stylers:[{saturation:-79},{visibility:"off"}]},{featureType:"water",stylers:[{visibility:"on"},{saturation:-85}]},{featureType:"road.highway",elementType:"labels",stylers:[{saturation:-67},{hue:"#ff9900"},{lightness:6},{visibility:"off"}]},{featureType:"road.arterial",elementType:"geometry",stylers:[{hue:"#ff6600"},{saturation:-75},{lightness:-21}]},{featureType:"poi",elementType:"labels",stylers:[{saturation:-84},{lightness:6},{visibility:"off"}]},{featureType:"transit.station",stylers:[{visibility:"off"}]},{featureType:"transit.line",stylers:[{visibility:"simplified"},{saturation:-27}]},{featureType:"poi.park",stylers:[{visibility:"on"},{saturation:-60},{gamma:1.91}]},{featureType:"poi.park",elementType:"labels",stylers:[{visibility:"off"}]},{featureType:"road.local",elementType:"labels",stylers:[{visibility:"on"}]},{featureType:"poi.attraction",stylers:[{saturation:-55}]}]},function(a){}(jQuery),$(document).ready(function(){var a=(window.location+"").split("/#"),b="",c=$(".navbar-toggle"),d=$("ul.nav.nav-sidebar li a[href=#]"),e=$("#projects"),f=$("#prj-showcase-wrap"),g=f.find("#prj-showcase"),h=$("#projects-pane"),i=parseInt(g.css("margin-top").replace("px",""))+parseInt(g.css("margin-bottom").replace("px",""))+parseInt($("#prj-showcase-separator").height()),j=$("#prj-showcase-content"),k=$("#prj-showcase-footer"),l=g.find("#prj-showcase-carousel"),m=$(".subnav ul"),n=m.parent(),o=$("#address-map");$.each(window.sitedata.projects,function(a,c){var d=1==c.category?"construction":2==c.category?"subproject":"private";linesClass=c.title.length>33?" three-lines":c.title.length>20?" two-lines":"",b+='<div class="project-wrap '+d+'" id="project-'+a+'" title="'+c.title+'" data-category="'+c.category+'"><div class="overlay"></div><img src="img/thumbs/'+c.thumb+'" alt="'+c.title+'" /><div class="caption-wrap'+linesClass+'"><div class="caption">'+c.title+"</div></div></div>"}),e.html(b);var q=function(a){var b=new Image;b.src=a},r=function(){$.each(window.sitedata.projects,function(a,b){$.each(b.images,function(a,b){q(window.mka.baseUrl+"/img/photos/"+b)}),q(window.mka.baseUrl+"/img/thumbs/"+b.thumb)})},s=function(a){var b=$("#logo");"hide"===a&&b.height()>0?TweenLite.to(b[0],window.mka.paneTransitionDur,{height:0,ease:Power3.easeIn}):"show"===a&&0==b.height()&&TweenLite.to(b[0],window.mka.paneTransitionDur,{height:"90px",ease:Power3.easeOut})},t=function(a,b,c){window.mka.firstLoad||a.hide(),"projects-pane"===a.attr("id")&&$("#prj-showcase-close").click();var d=b.attr("id");if("projects-pane"===d)b.scrollTop(0),e.isotope({layoutMode:"fitRows",filter:c,transitionDuration:"0.6s"});else if("contact-pane"===d&&null==window.mka.map){window.mka.map=new google.maps.Map(o[0],{center:window.mka.mapCenter,zoom:17,styles:window.mka.mapStyles});new google.maps.Marker({position:window.mka.mapCenter,map:window.mka.map,title:"MKA Architects"})}TweenLite.to("#"+b.attr("id"),window.mka.firstLoad?1:window.mka.paneTransitionDur,{paddingTop:0,opacity:1,ease:Power3.easeInOut})},u=function(a){"show"!=a||n.hasClass("expanded")?"hide"==a&&n.hasClass("expanded")&&TweenLite.to(n[0],.4,{height:0,ease:Power3.easeOut,onComplete:function(){n.removeClass("expanded")}}):TweenLite.to(n[0],.4,{height:m.height()+4+"px",ease:Power3.easeOut,onComplete:function(){n.addClass("expanded")}})},v=function(a){document.title=a.text()+" | MKA","true"==c.attr("aria-expanded")&&c.click();var b=a.attr("href"),d=window.mka.projectIds.indexOf(b)>=0,g=d?"#projects-pane":("#"==b?"#home":b)+"-pane",h="#private"==b?".private":"#constructions"==b?".construction":"#subprojects"==b?".subproject":"",i=$(window.mka.currentPaneId),j=$(g);return u(d?"show":"hide"),window.mka.currentPaneId!=g||window.mka.firstLoad?(window.mka.currentPaneId=g,j.show(),window.mka.firstLoad?(t(i,j,h),window.mka.firstLoad=!1):(dataLayer.push({event:"pageView",virtualUrl:"/"+("#"==b?"index":b)+".html"}),TweenLite.to("#"+i.attr("id"),.5,{paddingTop:"50px",opacity:0,ease:Power3.easeInOut,onComplete:function(){t(i,j,h)}})),void s("#home-pane"===g?"hide":"show")):(d&&(e.isotope({filter:h}),f.hasClass("showcasing")&&$("#prj-showcase-close").click()),!1)};$(".sidebar#menubar").find("ul.nav-sidebar").on("click","li a",function(a){v($(this))}),$("a.navbar-brand").click(function(a){v(d)});var w=function(){return f.height("auto")};$("#prj-showcase-close").on("click",function(){TweenLite.to(f[0],window.mka.projectTransitionDur,{height:0,opacity:0,ease:Power3.easeOut,onComplete:function(){f.removeClass("showcasing")}})});var y=function(a){var b=a.split("|");return b.length>1?b:[b[0],""]},z=function(a){var b="",c=window.sitedata.projects[a];window.mka.projectCache[a]?b=window.mka.projectCache[a]:(Modernizr.backgroundsize===!0?$.each(c.images,function(a,c){b+='<div class="img" style="background-image:url(\'img/photos/'+c+"');\"></div>"}):$.each(c.images,function(a,c){b+='<div><img src="img/photos/'+c+'" /></div>'}),window.mka.projectCache[a]=b),dataLayer.push({event:"projectView",projectTitle:c.title}),j.html('<div id="prj-showcase-title">'+c.title+"</div>"+c.content);var d=y(c.period),e=y(c.overseer);k.find("#prj-showcase-footer-research").text(d[0]),k.find("#prj-showcase-footer-construction").text(d[1]),k.find("#prj-showcase-footer-researcher").text(e[0]),k.find("#prj-showcase-footer-overseer").text(e[1]),l.hasClass("slick-initialized")&&l.slick("unslick"),l.html(b).slick({dots:!0,slidesToShow:1,variableWidth:!0,adaptiveHeight:!0})};e.on("click",".project-wrap",function(){var a=$(this).attr("id").replace("project-",""),b="fixed"==h.css("position")?"#projects-pane":"body";return TweenLite.to(b,window.mka.projectTransitionDur,{scrollTop:0,ease:Power3.easeOut}),f.hasClass("showcasing")?TweenLite.to(f[0],window.mka.projectTransitionDur,{opacity:0,ease:Power0.easeNone,onComplete:function(){z(a),f.height(g.height()+i),TweenLite.to(f[0],window.mka.projectTransitionDur,{opacity:1,ease:Power0.easeNone,onComplete:function(){w()}})}}):(z(a),f.addClass("showcasing"),TweenLite.to(f[0],window.mka.projectTransitionDur,{opacity:1,height:g.height()+i+"px",ease:Power3.easeOut,onComplete:function(){w()}})),!1}),$(window).resize(function(){"#contact-pane"==window.mka.currentPaneId&&window.mka.map.setCenter(window.mka.mapCenter)});var A=$("ul.nav.nav-sidebar li a[href=#"+(a.length>1?a[1]:"")+"]");0==A.length&&(A=d),A.click(),r()});